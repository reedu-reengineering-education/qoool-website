export const reeduPeople = [
  {
    id: 1,
    name: "Sergey Mukhametov",
    image: "https://reedu.de/assets/img/team/sergey_new.jpg",
    about:
      "Sergey leitet das QOOOL-Projekt und ist Co-Founder von re:edu. Er ist im QOOOL-Projekt für die Konzeption und Umsetzung des QOOOL-Kits verantwortlich.",
  },
  {
    id: 2,
    name: "Artur Kim Shum",
  ...
  },
  {
    ...
    image: "https://reedu.de/assets/img/team/gina_new.jpg",
    about:
      "Gina hat ihr Bachelor- und Masterstudium im Fach Kommunikationswissenschaft an der Universität Münster absolviert und arbeitet seit 2021 im Bereich Öffentlichkeitsarbeit/Kommunikation bei re:edu. Sie ist im QOOOL-Projekt für die Betreuung der Webseite und Social Media zuständig.",
  },
  {
    id: 4,
    name: "Felix Erdmann",
    ...
    about:
      "Felix ist Software Developer und kümmert sich im QOOOL-Projekt um die Entwicklung der Webseite und des Simulators. ✌️",
  },
  {
    id: 5,
    name: "Umut Taş",
...
export const ifmPeople = [
  ...
  },
  {
    ...
    image: require("@/assets/images/partners/ifm/Daniela_Walter.jpg").default.src
      .src,
    about:
...
export const iisPeople = [
  {
    ...
    image: require("@/assets/images/partners/iis/Bild_Jens_Anders.jpg").default.src
      .src,
    about:
  ...
  },
  {
    ...
    image: require("@/assets/images/partners/iis/Bild_Michal_Kern.png").default.src
      .src,
    about:
