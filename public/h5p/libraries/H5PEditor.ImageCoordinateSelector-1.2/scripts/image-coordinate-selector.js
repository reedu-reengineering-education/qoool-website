 ...
 * @param {H5P.jQuery} $
 */
H5PEditor.widgets.imageCoordinateSelector = H5PEditor.ImageCoordinateSelector =
  (function ($) {
    /**
    ...
    function ImageCoordinateSelector(parent, field, params, setValue) {
      ...
      this.imageField = H5PEditor.findField(
        this.field.imageFieldPath,
        this.parent
      )
      ...
      var resizeText = H5PEditor.t(
        "H5PEditor.ImageCoordinateSelector",
        "resize"
      )

      self.$container = $(
        H5PEditor.createFieldMarkup(
          this.field,
      ...
      self.$imgContainer = self.$container
        .find(".image-coordinate-selector")
    ...
    ImageCoordinateSelector.prototype.updateImage = function (path) {
      ...
      this.$imgContainer.append(
        '<img src="' + H5P.getPath(path, H5PEditor.contentId) + '">'
      )
