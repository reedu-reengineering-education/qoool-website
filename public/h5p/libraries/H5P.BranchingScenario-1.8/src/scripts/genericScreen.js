...
export default class GenericScreen extends H5P.EventDispatcher {
  ...
  constructor(parent, screenData = {}) {
    ...
    navButton.classList.add(
      this.screenData.isStartScreen ? "h5p-start-button" : "h5p-end-button"
    )
    ...
    if (
      ...
      this.screenData.titleText !== "" ||
      this.screenData.subtitleText !== ""
    ) {
  ...
  checkIntroReset() {
    ...
    if (
      finalScreenReachedClasses.every((i) =>
        this.screenWrapper.classList.contains(i)
      )
    ) {
