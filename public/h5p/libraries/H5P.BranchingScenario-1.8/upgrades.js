  ...
  return {
    1: {
      ...
      4: function (parameters, finished, extras) {
        ...
        parameters.branchingScenario.content =
          parameters.branchingScenario.content || []
        parameters.branchingScenario.behaviour =
          parameters.branchingScenario.behaviour || {}
      ...
      5: function (parameters, finished, extras) {
        // Sanitization
        parameters.branchingScenario = parameters.branchingScenario || {}
        parameters.branchingScenario.scoringOptionGroup =
          parameters.branchingScenario.scoringOptionGroup || {}

        // Change from scoringOption to scoringGroup
        parameters.branchingScenario.scoringOptionGroup.scoringOption =
          parameters.branchingScenario.scoringOption || "no-score"
