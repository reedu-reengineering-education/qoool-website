...
H5PPresave["H5P.MultiChoice"] = function (content, finished) {
  ...
  function isContentInvalid() {
    return (
      !presave.checkNestedRequirements(content, "content.answers") ||
  ...
  function isSinglePoint() {
    return (
      ...
      (presave.checkNestedRequirements(content, "content.behaviour.type") &&
        content.behaviour.type === "single")
    )
  }
}
