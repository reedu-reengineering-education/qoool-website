...
H5P.VideoYouTube = (function ($) {
  ...
  function YouTube(sources, options, l10n) {
          ...
          onApiChange: function () {
            ...
            if (trackList && trackList.length) {
              ...
              for (var i = 0; i < trackList.length; i++) {
                trackOptions.push(
                  new H5P.Video.LabelValue(
                    trackList[i].displayName,
                    trackList[i].languageCode
                  )
                )
              }
    ...
    self.setCaptionsTrack = function (track) {
      player.setOption(
        "captions",
        "track",
        track ? { languageCode: track.value } : {}
      )
    }
    ...
    self.getCaptionsTrack = function () {
      ...
      return track.languageCode
        ? new H5P.Video.LabelValue(track.displayName, track.languageCode)
        : null
    }
  ...
  var getId = function (url) {
    ...
    var matches = url.match(
      /(?:(?:youtube.com\/(?:attribution_link\?(?:\S+))?(?:v\/|embed\/|watch\/|(?:user\/(?:\S+)\/)?watch(?:\S+)v\=))|(?:youtu.be\/|y2u.be\/))([A-Za-z0-9_-]{11})/i
    )
