...
H5P.Video = (function ($, ContentCopyrights, MediaCopyright, handlers) {
  ...
  function Video(parameters, id, extras = {}) {
    ...
    parameters = $.extend(true, parameters, {
      l10n: {
        ...
        vimeoPasswordError:
          "Password-protected Vimeo videos are not supported.",
        vimeoPrivacyError:
          "The Vimeo video cannot be used due to its privacy settings.",
    ...
    if (sources.length) {
      const options = {
        ...
        poster:
          parameters.visuals.poster === undefined
            ? undefined
            : parameters.visuals.poster,
        tracks: tracks,
        disableRemotePlayback:
          parameters.visuals.disableRemotePlayback === true,
        disableFullscreen: parameters.visuals.disableFullscreen === true,
        deactivateSound: parameters.playback.deactivateSound,
      }
      if (!self.WAS_RESET) {
        options.startAt =
          self.oldTime !== undefined ? self.oldTime : parameters.startAt || 0
      }
  ...
  /** @constant {Boolean} */
  Video.IE11_PLAYBACK_RATE_FIX = navigator.userAgent.match(
    /Trident.*rv[ :]*11\./
  )
    ? true
    : false
