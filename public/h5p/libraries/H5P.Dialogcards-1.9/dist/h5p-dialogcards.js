;(() => {
    ...
    e = (function () {
      function e(e, t, a, i) {
        ...
        return (
          ...
          this.createCardContent(e).appendTo(this.$cardHolder),
          this
        )
      }
      var t = e.prototype
      return (
        (t.createCardContent = function (e) {
          var t = r("<div>", { class: "h5p-dialogcards-card-content" })
          this.createCardImage(e).appendTo(t)
          var a = r("<div>", {
          ...
          this.createCardAudio(e).appendTo(s)
          var n = r("<div>", { class: "h5p-dialogcards-card-text" }).appendTo(s)
          return (
            ...
            (e.text && e.text.length) || n.addClass("hide"),
            this.createCardFooter().appendTo(a),
            t
          )
        }),
        (t.massageAttributeOutput = function (r) {
          var e = new DOMParser().parseFromString(r, "text/html"),
            t = document.createElement("div")
          return (
            (t.innerHTML = e.documentElement.textContent),
            t.textContent || t.innerText || ""
          )
        }),
        (t.createCardImage = function (e) {
          this.$image
          var t = r("<div>", { class: "h5p-dialogcards-image-wrapper" })
          return (
            void 0 !== e.image
              ? ((this.image = e.image),
                (this.$image = r(
                ...
                e.imageAltText &&
                  this.$image.attr(
                    "alt",
                    this.massageAttributeOutput(e.imageAltText)
                  ))
              : (this.$image = r('<div class="h5p-dialogcards-image"></div>')),
            this.$image.appendTo(t),
            t
          )
        }),
        (t.createCardAudio = function (e) {
          if (
            (this.audio,
            ...
            ;((this.audio = new H5P.Audio(t, this.contentId)),
        ...
        (t.createCardFooter = function () {
          var e = r("<div>", { class: "h5p-dialogcards-card-footer" }),
            t = "h5p-dialogcards-button-hidden",
            a = "-1"
          return (
            "repetition" === this.params.mode &&
              ((t = ""),
              this.params.behaviour.quickProgression &&
                ((t = "h5p-dialogcards-quick-progression"), (a = "0"))),
        ...
        (t.turnCard = function () {
          var r = this,
            e = this.getDOM(),
            t = e.find(".h5p-dialogcards-card-content"),
            a = e
              .find(".h5p-dialogcards-cardholder")
              .addClass("h5p-dialogcards-collapse")
          t.find(".joubel-tip-container").remove()
          var i = t.hasClass("h5p-dialogcards-turned")
          ;(t.toggleClass("h5p-dialogcards-turned", !i),
            ...
            setTimeout(function () {
              if (
                ...
                var s = e.find(".h5p-dialogcards-answer-button")
        ...
        (t.stopAudio = function () {
          var r = this
          if (this.audio && this.audio.audio) {
            var e = this.audio.audio.duration
            ;(e > 0 && e < Number.MAX_SAFE_INTEGER && this.audio.seekTo(e),
        ...
        (t.getAnswer = function () {
          return this.card.answer
        }),
        (t.getImage = function () {
          return this.$image
        }),
        (t.getImageSize = function () {
          return this.image
        ...
        (t.reset = function () {
          ...
          var e = r.find(".h5p-dialogcards-card-content")
          ;(e.removeClass("h5p-dialogcards-turned"),
            this.addTipToCard(e, "front", this.id),
            this.params.behaviour.quickProgression ||
              r
                .find(".h5p-dialogcards-answer-button")
  ...
  ;((e.SCALEINTERVAL = 0.2), (e.MAXSCALE = 16), (e.MINSCALE = 4))
  const t = e
  const a = (function () {
    function r(r, e, t, a) {
      var i = this
      return (
        ...
        (this.idCounter = a),
        (this.cards = []),
        this.params.dialogs.forEach(function (r, e) {
          ;((r.id = e), i.cards.push(e))
        }),
        this
      )
    }
    var e = r.prototype
    return (
      (e.getCard = function (r) {
        if (!(r < 0 || r > this.cards.length))
          return (
            "number" == typeof this.cards[r] && this.loadCard(r),
            this.cards[r]
          )
      }),
      (e.getCardIds = function () {
        return this.cards.map(function (r, e) {
          return e
        })
      }),
      (e.loadCard = function (r) {
        r < 0 ||
          r > this.cards.length ||
    ...
    return (
      ...
      (e.peek = function (r) {
        ...
        return (
          (e = Math.max(0, e)),
          "top" === r && (r = 0),
          "bottom" === r && (r = this.cards.length - e),
          r < 0 || r > this.cards.length - 1 ? [] : this.cards.slice(r, r + e)
        )
      }),
      (e.add = function (r) {
        var e = this,
            ...
            ;-1 === e.cards.indexOf(a) &&
              ("top" === t
                ...
                : "bottom" === t
                  ? (t = e.cards.length)
                  : "random" === t &&
                    (t = Math.floor(Math.random() * e.cards.length)),
              (s = e.cards).splice.apply(s, [t, 0].concat(i(r))))
          }))
      }),
      (e.push = function (r) {
        this.add(r, "top")
      ...
      (e.pull = function () {
        ...
        return (
          ...
          "top" === e && (e = 0),
          "bottom" === e && (e = -r),
          (e = Math.max(0, Math.min(e, this.cards.length - 1))),
          this.cards.splice(e, r)
        )
      }),
      (e.remove = function (r) {
        var e = this
        ;("number" == typeof r && (r = [r]),
          r.forEach(function (r) {
            var t = e.cards.indexOf(r)
            t > -1 && e.cards.splice(t, 1)
          }))
      }),
      (e.shuffle = function () {
        for (var r = this.cards.length - 1; r > 0; r--) {
          var e = Math.floor(Math.random() * (r + 1)),
            t = [this.cards[e], this.cards[r]]
          ;((this.cards[r] = t[0]), (this.cards[e] = t[1]))
        }
        return this.cards
      }),
    ...
    return (
      ...
      (e.createPiles = function (r) {
        if (r)
          ...
          this.cardPiles = []
          var e = this.cardPool.getCardIds()
          switch (this.params.mode) {
            case "repetition":
              for (var t = 0; t < this.params.behaviour.maxProficiency + 1; t++)
                0 === t
                  ? this.cardPiles.push(new n(e))
      ...
      (e.updatePiles = function (r) {
        var e = this
        return (
          r.forEach(function (r) {
            var t = e.find(r.cardId)
            if (-1 !== t) {
              var a = !0 === r.result ? t + 1 : 0
              ;((a = Math.max(0, Math.min(a, e.cardPiles.length - 1))),
                e.cardPiles[t].remove(r.cardId),
                e.cardPiles[a].add(r.cardId, "bottom"))
            }
          }),
          this.getPileSizes()
        )
      }),
      (e.createSelectionRepetition = function () {
        for (var r = [], e = null, t = 0; t < this.cardPiles.length - 1; t++) {
          var a,
            i = this.cardPiles[t].length()
          if (null !== e || 0 !== i) {
            null === e && (e = t)
            var s = Math.ceil((1 * i) / (1 + t - e)),
              n = this.cardPiles[t].peek(0, s)
            r = (a = r).concat.apply(a, o(n))
          }
        }
        return (r = this.shuffle(r))
      }),
      (e.shuffle = function (r) {
        for (var e = r.slice(), t = e.length - 1; t > 0; t--) {
  ...
  const l = (function () {
    function r(r, e) {
      ...
      ;((this.params = r),
        (this.callbacks = e),
        (this.currentCallback = e.nextRound),
        (this.fields = []),
    ...
    return (
      ...
      (e.createContainerDOM = function (r) {
        var e =
        ...
        return (
          s.classList.add("h5p-dialogcards-summary-table"),
          t.appendChild(s),
          t
        )
      }),
      (e.addTableRow = function (r, e) {
        var t = r.getElementsByClassName("h5p-dialogcards-summary-table")[0],
          a = document.createElement("tr"),
          i = document.createElement("td")
        ;(i.classList.add("h5p-dialogcards-summary-table-row-category"),
          (i.innerHTML = e.category),
          a.appendChild(i))
        var s = document.createElement("td")
        ;(s.classList.add("h5p-dialogcards-summary-table-row-symbol"),
          void 0 !== e.symbol && "" !== e.symbol && s.classList.add(e.symbol),
          a.appendChild(s))
      ...
      (e.update = function () {
        ...
        ;(!0 === a
          ...
          c.forEach(function (e) {
            var t = void 0 !== e.score.value ? e.score.value : ""
            ;(void 0 !== e.score.max &&
              (t = ""
                .concat(
                  t,
      ...
      (e.createConfirmationDialog = function (r, e) {
        r = r || {}
        ...
        return (
          ...
          (s.createDOM = function (r) {
            if (
              ...
              var e = p("<div>" + s.params.title + "</div>")
                .text()
                .trim()
              ;((s.$header = p(
                (e
          ...
          (s.createFooter = function () {
            var r = p("<nav>", {
              ...
              e = function (r, e) {
                ;(p(r).append('<span class="button-tooltip">' + e + "</span>"),
          ...
          (s.updateImageSize = function () {
            var r = 0,
              e = s.cards[s.currentCardId]
                .getDOM()
                .find(".h5p-dialogcards-card-content")
            if (
              (s.params.dialogs.forEach(function (t) {
                if (t.image) {
                  var a =
                    (t.image.height / t.image.width) *
                    e.get(0).getBoundingClientRect().width
                  a > r && (r = a)
                }
              }),
              r > 0)
            ) {
              var t = r / parseFloat(s.$inner.css("font-size"))
              ;(t > 15 && (t = 15),
          ...
          (s.initCards = function (r) {
            ...
            for (
              var e = p("<div>", { class: "h5p-dialogcards-cardwrap-set" }),
                t = 0;
              t < r.length && !(t >= 2);
              t++
            ) {
              var a = s.getCard(r[t])
              ;(a.setProgressText(t + 1, r.length), s.cards.push(a))
              var i = a.getDOM()
              ;(t === s.currentCardId &&
          ...
          (s.showSummary = function () {
            var r =
              ...
              e = s.results.filter(function (r) {
                return !0 === r.result
              }).length,
              t = s.results.length - e,
              a = s.cardPoolSize - e - t,
              i = r.slice(-1)[0],
              n = i === s.cardPoolSize,
              o = {
                round: s.round,
                results: [
                  {
                    ...
                    score: { value: e, max: t + e },
                  },
                  {
                    field: "h5p-dialogcards-round-cards-wrong",
                    score: { value: t, max: t + e },
                  },
                  {
          ...
          (s.getCard = function (r) {
            var e = s.cardManager.getCard(r)
            return (e.createButtonListeners(), e)
          }),
          (s.findCardPosition = function (r) {
            var e
            return (
              s.cards.forEach(function (t, a) {
                e || t.id !== r || (e = a)
              }),
              e
            )
          }),
          (s.insertCardToDOM = function (r, e) {
            var t = r.getDOM()
            ;(void 0 === e
              ? t.appendTo(s.$cardwrapperSet)
              : 0 === e
                ? s.$cardwrapperSet.prepend(t)
                : s.$cardwrapperSet.children().eq(e).after(t),
              r.addTipToCard(
                t.find(".h5p-dialogcards-card-content"),
                "front",
                e
              ))
          }),
          (s.gotoCard = function (r) {
            if (!(r < 0 || r >= s.cardIds.length)) {
              var e = s.cards[s.currentCardId]
              ;(e.stopAudio(),
                e.getDOM().removeClass("h5p-dialogcards-current"))
              var t = []
              ;(r > 0 && t.push(r - 1),
                t.push(r),
                r + 1 < s.cardIds.length && t.push(r + 1),
                t.forEach(function (r) {
                  if (void 0 === s.findCardPosition(s.cardIds[r])) {
                    var e = s.getCard(s.cardIds[r])
                    e.setProgressText(r + 1, s.cardIds.length)
                    var t = Math.min(r + 1, s.cardIds.length - 1),
                      a = s.findCardPosition(s.cardIds[t]) || s.cards.length
                    ;(s.cards.splice(a, 0, e), s.insertCardToDOM(e, a))
                  }
                }),
                s.resize(),
                (r = s.findCardPosition(s.cardIds[r])),
                s.cards.forEach(function (e, t) {
                  t < r
                    ? e.getDOM().addClass("h5p-dialogcards-previous")
                    : (e.getDOM().removeClass("h5p-dialogcards-previous"),
                      t === r && e.getDOM().addClass("h5p-dialogcards-current"))
                }),
                (s.currentCardId = r),
                s.updateNavigation(),
          ...
          (s.resize = function () {
            if (s.cards[s.currentCardId].isInTransition || s.resizeTimeout)
              s.resizeTimeout = setTimeout(function () {
                ;(delete s.resizeTimeout, s.resize())
              }, 400)
            else {
              var r = 0
              ;(s.updateImageSize(),
                ...
                s.$cardwrapperSet
                  ...
                  .each(function () {
                    var e = p(this).css("height", "initial").outerHeight()
                    if (
              ...
              var e = r / parseFloat(s.$cardwrapperSet.css("font-size"))
              ;(s.$cardwrapperSet.css("height", e + "em"),
                s.scaleToFitHeight(),
                s.truncateRetryButton(),
                s.cards[s.currentCardId].resizeOverflowingText())
            }
          ...
          (s.determineCardSizes = function () {
            ...
            ;(void 0 === s.cardSizeDetermined && (s.cardSizeDetermined = []),
              s.$cardwrapperSet.children(":visible").each(function (e) {
                var t = r.cards[e].id
                if (-1 === r.cardSizeDetermined.indexOf(t)) {
                  r.cardSizeDetermined.push(t)
          ...
          (s.scaleToFitHeight = function () {
            if (
              ...
              if (s.$inner.parents(".h5p-course-presentation").length) {
                ...
                var e = r.get(0).getBoundingClientRect().height,
                  t = function () {
                    var r = 0
                    return (
                ...
                if (e < i)
                  for (; e < i && !((o -= a.SCALEINTERVAL) < a.MINSCALE); )
                    (s.$inner.css("font-size", o / n + "em"), (i = t()))
                else
                  for (var d = !0; d; ) {
          ...
          (s.truncateRetryButton = function () {
            if (s.$retry) {
              ;(s.$retry.removeClass("truncated"),
                s.$retry.html(s.params.retry))
