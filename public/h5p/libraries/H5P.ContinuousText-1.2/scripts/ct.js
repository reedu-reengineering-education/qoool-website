...
H5P.ContinuousText = function (params) {
  this.text =
    params.text === undefined
      ? '<div class="ct"><em>New text</em></div>'
      : '<div class="ct">' + params.text + "</div>"
}
...
H5P.ContinuousText.Engine = (function () {
  ...
  return {
    run: function (cpEditor) {
      ...
      var opacity =
        cpEditor.ct.params.backgroundOpacity === undefined ||
        cpEditor.ct.params.backgroundOpacity === 0
          ? null
          : cpEditor.ct.params.backgroundOpacity
