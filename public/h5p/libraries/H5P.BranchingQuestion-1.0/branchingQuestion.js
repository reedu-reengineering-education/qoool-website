    ...
    var appendMultiChoiceSection = function (parameters, wrapper) {
      ...
      alternatives.forEach(function (altParams, index, array) {
        ...
        if (hasFeedback && altParams.nextContentId !== -1) {
          ...
          alternative.proceedButton =
            alternative.feedbackScreen.querySelectorAll("button")[0]
        }
        ...
        alternative.onclick = function (e) {
          if (this.feedbackScreen !== undefined) {
            ...
            this.feedbackScreen.setAttribute(
              "aria-labelledby",
              "h5p-feedback-content-title"
            )
            this.feedbackScreen.setAttribute(
              "aria-describedby",
            ...
            var alts = questionWrapper.querySelectorAll(
              ".h5p-branching-question-alternative"
            )
            var index2
      ...
      if (
        parameters.branchingQuestion.randomize &&
        !questionWrapper.dataset.shuffled
      ) {
        const alternatives = [
          ...questionWrapper.querySelectorAll(
            "button.h5p-branching-question-alternative"
          ),
        ]
