      ...
      1: {
        contentUpgrade: function (parameters, finished) {
          ...
          parameters.behaviour = {
            ...
            autoCheck:
              parameters.autoCheck === undefined ? false : parameters.autoCheck,
            caseSensitive:
            ...
            separateLines:
              parameters.separateLines === undefined
                ? false
                : parameters.separateLines,
          }
      ...
      12: function (parameters, finished) {
        ...
        if (parameters && parameters.media) {
          parameters.media = {
            ...
            disableImageZooming:
              parameters.behaviour && parameters.behaviour.disableImageZooming
                ? parameters.behaviour.disableImageZooming
                : false,
          }
        }
