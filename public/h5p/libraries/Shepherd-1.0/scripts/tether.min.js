!(function (t, e) {
  ...
  var O = (function () {
    ...
    x = function (t) {
      ...
      void 0 === e &&
        ((e = t.createElement("div")).setAttribute("data-tether-id", O()),
        h(e.style, { top: 0, left: 0, position: "absolute" }),
              ...
              if (void 0 !== this.bindings && this.bindings[t])
                for (var e = 0; e < this.bindings[t].length; ) {
                  ...
                  for (
                    ...
                    h[l - 1] = arguments[l]
                  ;(i.apply(s, h), r ? this.bindings[t].splice(e, 1) : ++e)
                }
            },
          },
        ]),
  ...
  var n = (R = C.Utils).getScrollParent,
    s = ((r = R.getBounds), R.getOffsetParent),
    f = ((h = R.extend), R.addClass),
    l = R.removeClass,
    a =
      ((c = R.updateClasses), (T = R.defer), (S = R.flush), R.getScrollBarSize),
    P = (function () {
      for (
        var t = document.createElement("div"),
          e = [
    ...
    var t = null,
      ...
      i = function i() {
        return void 0 !== e && e > 16
          ...
          : void (
              (void 0 !== t && v() - t < 10) ||
              (void 0 !== o && (clearTimeout(o), (o = null)),
              (t = v()),
              B(),
              (e = v() - t))
            )
  ...
  var _ = { center: "center", left: "right", right: "left" },
        ...
        w(t, [
            ...
            value: function () {
              ...
              if ("scroll-handle" === this.targetModifier) {
                ...
                var n =
                  ...
                  s = {
                    width: 15,
                    height: 0.975 * n * (n / e.scrollHeight),
                    left: t.left + t.width - parseFloat(o.borderLeftWidth) - 15,
                  },
                  a = 0
                ;(408 > n &&
                  this.target === document.body &&
                  (a = -11e-5 * Math.pow(n, 2) - 0.00727 * n + 22.58),
                  this.target !== document.body &&
                    (s.height = Math.max(s.height, 24)))
                var h = this.target.scrollTop / (e.scrollHeight - n)
                return (
                  (s.top =
                    h * (n - s.height - a) +
                    t.top +
          ...
          },
          {
            ...
            value: function () {
              var t = this
              ;(this.disable(),
                k.forEach(function (e, o) {
                  return e === t ? void k.splice(o, 1) : void 0
                }))
            },
          },
          {
            ...
            value: function (t, e) {
              ...
              ;(t.top &&
                i.push(this.getClass("element-attached") + "-" + t.top),
                t.left &&
              ...
              ;(["left", "top", "bottom", "right", "middle", "center"].forEach(
                function (t) {
                  ;(n.push(o.getClass("element-attached") + "-" + t),
                    n.push(o.getClass("target-attached") + "-" + t))
                }
              ),
                T(function () {
                  void 0 !== o._addAttachClasses &&
                    (c(o.element, o._addAttachClasses, n),
                    !1 !== o.options.addTargetClasses &&
                      c(o.target, o._addAttachClasses, n),
            ...
            value: function () {
              ...
              if (this.enabled) {
                ...
                var i = this.cache("element-bounds", function () {
                  ...
                  n = i.width,
                  h = i.height
                if (0 === n && 0 === h && void 0 !== this.lastSize) {
                  var l = this.lastSize
                  ;((n = l.width), (h = l.height))
                } else this.lastSize = { width: n, height: h }
                var f = this.cache("target-bounds", function () {
                    return t.getTargetBounds()
                  }),
                  d = f,
                  p = b(L(this.attachment), { width: n, height: h }),
                  u = b(L(o), d),
                  c = b(this.offset, { width: n, height: h }),
                  g = b(this.targetOffset, d)
                ;((p = m(p, c)), (u = m(u, g)))
                for (
                  var v = f.left + u.left - p.left,
                    y = f.top + u.top - p.top,
                    w = 0;
                  w < C.modules.length;
                  ++w
                ) {
                  var O = C.modules[w].position.call(this, {
                    left: v,
                    top: y,
                    targetAttachment: o,
                    targetPos: f,
                ...
                var E = {
                    ...
                    viewport: {
                      top: y - pageYOffset,
                      bottom: pageYOffset - y - h + innerHeight,
                      left: v - pageXOffset,
                ...
                return (
                  document.body.scrollWidth > window.innerWidth &&
                    ((x = this.cache("scrollbar-size", a)),
                    (E.viewport.bottom -= x.height)),
                  document.body.scrollHeight > window.innerHeight &&
                    ((x = this.cache("scrollbar-size", a)),
                    (E.viewport.right -= x.width)),
                  (-1 ===
                    ...
                    ((E.page.bottom = document.body.scrollHeight - y - h),
                    (E.page.right = document.body.scrollWidth - v - n)),
                    ...
                    (function () {
                      ...
                      if (
                        ...
                        (o.bottom =
                          ...
                          n.height +
                          a.bottom),
                        E.page.top >= o.top + a.top &&
                          E.page.bottom >= o.bottom &&
                          E.page.left >= o.left + a.left &&
                          E.page.right >= o.right)
                      ) {
                        var h = e.scrollTop,
                          l = e.scrollLeft
                        E.offset = {
                          top: E.page.top - o.top + h - a.top,
                          left: E.page.left - o.left + l - a.left,
                        }
                      }
                    })(),
                  this.move(E),
            ...
            value: function (t) {
              ...
              if (void 0 !== this.element.parentNode) {
                    ...
                    if (
                      ...
                      ;(t.top
                        ...
                        (f[P] =
                          ...
                          Math.round(i) +
                          "px)"),
                        "msTransform" !== P && (f[P] += " translateZ(0)"))
                    } else
                      (t.top
                        ? (f.top = o.top + "px")
                        : (f.bottom = o.bottom + "px"),
                        t.left
                          ? (f.left = o.left + "px")
                          : (f.right = o.right + "px"))
                  },
                ...
                ;((o.page.top || o.page.bottom) && (o.page.left || o.page.right)
                  ? ((f.position = "absolute"), d(o.page, t.page))
                  : (o.viewport.top || o.viewport.bottom) &&
                      (o.viewport.left || o.viewport.right)
                    ? ((f.position = "fixed"), d(o.viewport, t.viewport))
                ...
                for (var n in f) {
                  var v = f[n],
                    m = this.element.style[n]
                  ;("" !== m &&
                    "" !== v &&
                    ["top", "left", "bottom", "right"].indexOf(n) >= 0 &&
                    ((m = parseFloat(m)), (v = parseFloat(v))),
                    m !== v && ((c = !0), (u[n] = v)))
                }
                c &&
                  T(function () {
  ...
  var j = h(X, C),
    h =
      ...
      (r = (R = C.Utils).getBounds),
      R.extend),
    N =
      ((c = R.updateClasses), (T = R.defer), ["left", "top", "right", "bottom"])
  C.modules.push({
    position: function (t) {
      var e = this,
        o = t.top,
      ...
      return (
        this.options.constraints.forEach(function (t) {
          ...
          var w = y(e, r)
          ;(("target" === d || "both" === d) &&
            (o < w[1] && "top" === m.top && ((o += p), (m.top = "bottom")),
            o + a > w[3] && "bottom" === m.top && ((o -= p), (m.top = "top"))),
            "together" === d &&
              (o < w[1] &&
                "top" === m.top &&
                ("bottom" === b.top
                  ? ((o += p), (m.top = "bottom"), (o += a), (b.top = "top"))
                  : "top" === b.top &&
                    ((o += p),
                    (m.top = "bottom"),
                    (o -= a),
              ...
              o + a > w[3] &&
                "bottom" === m.top &&
                ("top" === b.top
                  ? ((o -= p), (m.top = "top"), (o -= a), (b.top = "bottom"))
                  : "bottom" === b.top &&
                    ((o -= p), (m.top = "top"), (o += a), (b.top = "top"))),
              "middle" === m.top &&
                (o + a > w[3] && "top" === b.top
                  ? ((o -= a), (b.top = "bottom"))
                  : o < w[1] &&
                    ...
                    ((o += a), (b.top = "top")))),
            ("target" === f || "both" === f) &&
              (i < w[0] && "left" === m.left && ((i += u), (m.left = "right")),
              i + l > w[2] &&
                "right" === m.left &&
                ((i -= u), (m.left = "left"))),
            "together" === f &&
              (i < w[0] && "left" === m.left
                ? "right" === b.left
                  ? ((i += u), (m.left = "right"), (i += l), (b.left = "left"))
                  : "left" === b.left &&
                    ((i += u), (m.left = "right"), (i -= l), (b.left = "right"))
                : i + l > w[2] && "right" === m.left
                  ? "left" === b.left
                    ? ((i -= u),
                      (m.left = "left"),
                      (i -= l),
                      (b.left = "right"))
                    : "right" === b.left &&
                      ((i -= u), (m.left = "left"), (i += l), (b.left = "left"))
                  : "center" === m.left &&
                    (i + l > w[2] && "left" === b.left
                      ? ((i -= l), (b.left = "right"))
                      : i < w[0] &&
                        ...
                        ((i += l), (b.left = "left")))),
            ("element" === d || "both" === d) &&
              (o < w[1] && "bottom" === b.top && ((o += a), (b.top = "top")),
              o + a > w[3] &&
                "top" === b.top &&
                ((o -= a), (b.top = "bottom"))),
            ("element" === f || "both" === f) &&
              (i < w[0] && "right" === b.left && ((i += l), (b.left = "left")),
              i + l > w[2] &&
                "left" === b.left &&
                ((i -= l), (b.left = "right"))),
            "string" == typeof h
          ...
          ;(o < w[1] &&
            ...
            (m.top !== n.top ||
              ...
              e.updateAttachClasses(b, m))
        }),
        T(function () {
          ;(!1 !== e.options.addTargetClasses && c(e.target, v, g),
            c(e.element, v, g))
        }),
        { top: o, left: i }
      )
    ...
    C.modules.push({
      position: function (t) {
        ...
        return (
          ...
          T(function () {
            ;(!1 !== e.options.addTargetClasses && c(e.target, u, p),
              c(e.element, u, p))
          }),
          !0
        )
