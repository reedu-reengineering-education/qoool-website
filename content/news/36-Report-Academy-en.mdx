...
It was a course that sparkled, sparkled and sometimes even danced: this year's Student Academy in Papenburg impressively demonstrated how seemingly contradictory disciplines such as biology and quantum physics can be combined to form a fascinating whole. The ‘Bioquantum Physics’ course, led by Anja Galm and Simon Koppenhöfer, brought together 16 highly motivated young people – with a delivery van full of experiments, two 3D printers and a thirst for research.

During the academy, participants worked on the ‘Salad Disco’ and emulated night-time brain wave measurements. They simulated quantum mechanical processes, developed their own experiments and demonstrated that they were not afraid of either primary literature or circuit boards for LED irradiation.
...
But that's not all: the group also ventured into simulating quantum mechanical colour formation in salts and molecules such as retinol. Some of the calculated absorption wavelengths were only ±30 nm away from the experimental value – an impressive achievement for school students with no prior knowledge of quantum mechanics. In addition, neural bursts (short phases in which nerve cells send out many electrical signals in rapid succession), NV centres in diamonds and the navigation of birds in the Earth's magnetic field were also discussed, demonstrating the enormous thematic range – and scientific depth – of the course.
